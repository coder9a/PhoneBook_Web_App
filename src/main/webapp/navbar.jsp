...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
    <form class="form-inline my-2 my-lg-0">
    	<button class="btn btn-btn-success"><%= user.getName() %></button>  
		<a data-toggle="modal" data-target="#exampleModalCenter" href="LogoutServlet" class="btn btn-danger ml-2 text-white">Logout</a>
	</form>
    <% 	
    }
    %>
